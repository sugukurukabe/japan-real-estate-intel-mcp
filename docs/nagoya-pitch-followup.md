...
台本・録画手順: [demo-video-script.md](./demo-video-script.md)  
録画コマンド: `pnpm run demo:record` → `docs/screenshots/demo-preview.webm`

<!-- 公開後: YouTube / note URL をここに追記 -->
...
**一覧:** [free-demo-prompts.md](./free-demo-prompts.md)
