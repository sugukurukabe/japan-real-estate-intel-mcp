...
const FUKUOKA_GEOCODE: Record<string, LatLng> = {
  ...
  福岡市博多区: { lat: 33.5904, lng: 130.42 },
  福岡市東区: { lat: 33.6183, lng: 130.4324 },
  福岡市南区: { lat: 33.5538, lng: 130.418 },
  福岡市西区: { lat: 33.5831, lng: 130.339 },
  福岡市城南区: { lat: 33.5621, lng: 130.3731 },
  福岡市早良区: { lat: 33.5696, lng: 130.3498 },
  福岡市北九州市: { lat: 33.8834, lng: 130.875 },
  北九州市小倉北区: { lat: 33.8834, lng: 130.875 },
  北九州市小倉南区: { lat: 33.8501, lng: 130.898 },
  北九州市八幡西区: { lat: 33.8701, lng: 130.798 },
  北九州市八幡東区: { lat: 33.865, lng: 130.828 },
