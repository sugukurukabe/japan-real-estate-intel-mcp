...
const AICHI_GEOCODE: Record<string, LatLng> = {
  ...
  名古屋市天白区: { lat: 35.1204, lng: 136.968 },
  ...
  常滑市: { lat: 34.892, lng: 136.837 },
  江南市: { lat: 35.3319, lng: 136.8694 },
  大府市: { lat: 35.01, lng: 136.9622 },
  ...
  蒲郡市: { lat: 34.8268, lng: 137.218 },
  西尾市: { lat: 34.8642, lng: 137.0612 },
  新城市: { lat: 34.9097, lng: 137.498 },
};
...
export class AichiLoader extends BaseLoader {
  ...
  getLandslideZones(): FeatureCollection {
    return this.loadGeoJson('landslide.geojson');
  }
  ...
  getPlateauBuildings(): PlateauBuildingRecord[] {
    return this.loadJson('plateau_buildings.json', []);
  }
